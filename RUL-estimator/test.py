...
""" Two LSTM layers - check dropout and sizes and return_sequences """
...
""" Output layers: Dense(ann_hidden) -> Dropout(1-keep_prob) -> Dense(1)"""
...
print(no_of_batches)
x_train_all = np.zeros((no_of_batches*batch_size, 100, 24))
y_train_all = np.zeros((no_of_batches*batch_size, 100))
